...
Route::group([], function () {
    ...
    Route::post('/googleregister', [LoginController::class, 'googleRegister'])->name('googleregister');
    ...
    Route::group(['as'=> 'user.', 'prefix' => 'user'],function (){
        ...
        Route::get('ontheway-order', [UserProfileController::class, 'onTheWayOrder'])->name('ontheway-order');
        ...
        Route::group(['as'=> 'checkout.', 'prefix' => 'checkout'],function (){
            ...
            Route::post('/pay-with-paytm', [PaymentController::class, 'OnlinePaytm'])->name('pay-with-paytm');
